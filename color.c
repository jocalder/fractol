...
/*   Updated: 2025/03/03 18:24:20 by jocalder         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	color_origin(t_fractal *fractal)
{
	int		red;
	int		blue;
	int		green;
	...
	t = (double)fractal->max_iter / (double)fractal->max_iter;
...
static int	color_variation(t_fractal *fractal)
{
	int		red;
	int		blue;
	int		green;
...
{
	if (fractal->color == 0)
		return (color_origin(fractal));
	return (color_variation(fractal));
}
